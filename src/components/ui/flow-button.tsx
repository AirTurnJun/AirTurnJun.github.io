    ...
    <div className={cn("ring-primary/60 relative isolate w-fit overflow-hidden rounded-lg ring-2", className)}>
      <Button
        ...
        className={cn(
          ...
          "after:absolute after:-inset-[7.5rem] after:-z-[1] after:rounded-[inherit] after:border after:border-[inherit] after:bg-origin-border after:transition-transform after:duration-500 after:[-webkit-mask-composite:xor] after:[mask-composite:exclude]",
    ...
    <div className={cn("ring-secondary/60 relative isolate w-fit overflow-hidden rounded-lg ring-2", className)}>
      <Button
        ...
        className={cn(
          ...
          size === "lg" && "text-base has-[>svg]:px-6",
          "after:absolute after:-inset-[7.5rem] after:-z-[1] after:rounded-[inherit] after:border after:border-[inherit] after:bg-origin-border after:transition-transform after:duration-500 after:[mask:linear-gradient(#000,#000),linear-gradient(#000,#000)] after:[mask-clip:content-box,border-box] after:[-webkit-mask-composite:xor] after:[mask-composite:exclude]",
